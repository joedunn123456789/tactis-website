...
$config['technicalcontact_name'] = "Tactis IT";
$config['technicalcontact_email'] = "it@tactis.com";

// Change these for your installation.
$config['secretsalt'] = 'dfg98sfgd897sdf9780ds0o8yshkldslhi';
$config['auth.adminpassword'] = 'T@ct1s!saml';
...
if (!getenv('AH_SITE_ENVIRONMENT')) {
  ...
  $config['store.sql.dsn'] = sprintf('mysql:host=%s;port=%s;dbname=%s', 'db', '3306', 'db');
  $config['store.sql.username'] = 'db';
  $config['store.sql.password'] = 'db';
  $config['store.sql.prefix'] = 'simplesaml';
  $config['certdir'] = "/var/www/html/vendor/simplesamlphp/simplesamlphp/cert/";
  $config['metadatadir'] = "/var/www/html/vendor/simplesamlphp/simplesamlphp/metadata";
  $config['baseurlpath'] = 'simplesaml/';
  $config['loggingdir'] = '/var/www/html/simplesamlphp/log/';
